...
- [ ] Item detail panel (left of game area)
...
**Current Status: ✅ Core loop working!**
...
1. **Item detail panel** (left of game area)
   - Icon preview
   - Short description (journal prose)
   - Technical description (what the code actually does)

2. **Player death/respawn** - currently stays dead at 0 HP

3. **Balance tuning** - enemies might deal too much damage
...
**Next Steps:**
1. Item detail panel (icon + short + technical description)
