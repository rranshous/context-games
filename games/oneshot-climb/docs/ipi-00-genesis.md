...
Currently items are mostly beneficial (buffs, friendly helpers). We need more variety - some items should be dangerous! The game should feel risky.

**Design Goal: Item Variety**
Items can be:
- **Pure good** - just buffs/helpers
- **Pure bad** - just spawns enemies or debuffs
- **Mixed** - tradeoffs (speed boost + chasing enemy, heal + boss spawn)

The key is VARIETY. Right now almost everything is good. We need enemies to appear!
...
"Items can be good, bad, or mixed. Variety is key!
Some items should spawn enemies - a single boss, a horde, or continuous spawning.
Don't be afraid to make purely dangerous items."
```
