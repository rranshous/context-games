...
Player takes damage but has no health bar or death state. The game needs:
- Visible player health UI
- Player death and respawn
- Maybe knockback when hit
...
4. Check that player health depletes and respawns work
...
1. Implement player health bar and death/respawn
2. Add entity-to-entity collision (not just player)
3. Consider `entity.destroy()` as alias for `world.removeEntity(entity)`
4. Add entity knockback on hit
5. Throttle damage spam further (per-entity cooldown implemented but still noisy)
